...
**Week 18 — Docker and Environment Config:** [README](README.md) · [Notes](notes.md) · [Exercises](exercises.md) · [Break It](break_it.md) · [Validation](validation.md) · **Reflection**

⬅️ [← Validation](validation.md) · ➡️ [📝 Week 18 Report](../../../docs/weekly-reports/README.md) · [Week 19 →](../week-19-documentation-portfolio-polish/README.md)

---
<!-- NAV_END -->

# Reflection — Week 18 Docker and Environment Configuration
...
- **Can I explain why Week 18 comes after Week 17 (RAG Assistant)?**
...
When you have completed this reflection, write your [Week 18 report](../../../docs/weekly-reports/README.md).

Store it at `docs/weekly-reports/week-18-report.md` (see the [weekly reports guide](../../../docs/weekly-reports/README.md) for the template).

Once your report is committed, advance to [Week 19 →](../week-19-documentation-portfolio-polish/README.md).
<!-- WEEKLY_REPORT_END -->
