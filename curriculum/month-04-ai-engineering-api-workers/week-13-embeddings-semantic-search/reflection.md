...
**Week 13 — Embeddings and Semantic Search:** [README](README.md) · [Notes](notes.md) · [Exercises](exercises.md) · [Break It](break_it.md) · [Validation](validation.md) · **Reflection**

⬅️ [← Validation](validation.md) · ➡️ [📝 Week 13 Report](../../../docs/weekly-reports/README.md) · [Week 14 →](../week-14-fastapi-layer/README.md)
...
When you have completed this reflection, write your [Week 13 report](../../../docs/weekly-reports/README.md).

Store it at `docs/weekly-reports/week-13-report.md` (see the [weekly reports guide](../../../docs/weekly-reports/README.md) for the template).

Once your report is committed, advance to [Week 14 →](../week-14-fastapi-layer/README.md).
<!-- WEEKLY_REPORT_END -->
