...
<!-- NAV:TOP:START -->
> **You are here:** [🏠 Home](../../../README.md) › [🗺️ Roadmap](../../../ROADMAP.md) › [Month 4](../README.md) › [Week 14 — FastAPI Layer](./README.md) › **notes.md**
>
...
**Where am I?** Month 4 — AI Engineering, API, Async, Workers · **Week 14 — FastAPI Layer** · *notes.md — the textbook chapter* (step 2 of 6 this week).
