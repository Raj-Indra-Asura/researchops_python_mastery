...
<!-- NAV:TOP:START -->
> **You are here:** [🏠 Home](../../../README.md) › [🗺️ Roadmap](../../../ROADMAP.md) › [Month 4](../README.md) › [Week 15 — Async I/O Network Fetching](./README.md) › **break_it.md**
>
...
**Where am I?** Month 4 — AI Engineering, API, Async, Workers · **Week 15 — Async I/O Network Fetching** · *break_it.md — the failure lab* (step 4 of 6 this week).
